...
public class Behaviors {
	...
	public static void main(String[] args) {
		...
		FollowColourPath followColourPath = new FollowColourPath(pilot);
		LowBattery lowBattery = new LowBattery(pilot);
		MainClass connect = new MainClass(pilot);
		FollowColorZ followColorZ = new FollowColorZ(pilot);
		SpinModif spin = new SpinModif(pilot);
	
		
		Arbitrator ab = new Arbitrator(new Behavior[] {trundle, followColourPath, light, d, lowBattery});
		ab.go();
	}
